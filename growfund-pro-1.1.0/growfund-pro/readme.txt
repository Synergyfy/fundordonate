...
= 1.1.0 - May 8, 2026 =
* Introduced a Collaborator role for campaign management. (PRO)
* Added fundraiser support in the Campaign Builder. (PRO)
* Implemented a fundraiser wallet and withdrawal system. (PRO)
* Added platform fee configuration for admin earnings. (PRO)
...
* Fixed the fundraiser activity log issue (PRO).
* Fixed WP Crowdfunding to Growfund migration issues.
* Resolved the checkout consent issue.
* Fixed license manager (PRO).

= 1.0.2 - Dec 18, 2025 =
* Added attributes in shortcodes
* Added branding in frontend (PRO)
* Added donor/backer can be assigned as fundraiser (PRO)
...
* Fixed revenue breakdown (PRO)
* Fixed migration from wp crowdfunding
* Fixed guest checkout (PRO)
* Fixed pot files
* Fixed donor list as a fundraiser (PRO)
