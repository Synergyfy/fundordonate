...
class CampaignApprovedMail extends Mailer
{
    protected $content_key = MailKeys::FUNDRAISER_CAMPAIGN_APPROVED;
    ...
    public function with($data)
    {
        ...
        if (
            $campaign_dto->status !== CampaignStatus::PUBLISHED 
            || (int) ($campaign_dto->fundraiser->id ?? 0) !== $user->get_id()
        ) {
            $this->ignore_mail();
        }
