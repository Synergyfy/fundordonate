// =============================================================================
// Consumers Overview — Admin
// Consumer activity command view with key metrics and drill-down.
// =============================================================================

import { Link } from "react-router-dom";
import { ChevronRight, Users, TrendingUp, Target, Trophy, Wallet, Star } from "lucide-react";

const fmt = (p: number) => new Intl.NumberFormat("en-GB", { style: "currency", currency: "GBP", maximumFractionDigits: 0 }).format(p / 100);

const DEMO_STATS = {
  totalConsumers: 8400,
  activeConsumers: 5200,
  totalCampaigns: 156,
  activeCampaigns: 68,
  totalRaised: 12400000,
  totalTarget: 22000000,
  totalBackers: 4800,
  totalFoundingMembers: 720,
  totalMembership: 1200,
  rewardsIssued: 340,
};

const DEMO_TOP_CAMPAIGNS = [
  { id: "c1", name: "London Community Garden", raised: 85000, target: 100000, backers: 420, city: "London" },
  { id: "c2", name: "Manchester Youth Programme", raised: 62000, target: 80000, backers: 280, city: "Manchester" },
  { id: "c3", name: "Birmingham Food Bank", raised: 45000, target: 50000, backers: 190, city: "Birmingham" },
  { id: "c4", name: "Leeds Arts Centre", raised: 38000, target: 60000, backers: 150, city: "Leeds" },
];

const DEMO_RECENT_ACTIVITY = [
  { time: "1 hour ago", text: "New consumer registered: Emily Johnson from London", type: "registration" },
  { time: "3 hours ago", text: "Campaign milestone: London Community Garden reached 85%", type: "milestone" },
  { time: "6 hours ago", text: "Consumer campaign completed: Bristol Community Kitchen", type: "completion" },
  { time: "1 day ago", text: "25 new consumers joined from Manchester", type: "registration" },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500">Consumer activity overview across the platform</p>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          ...
          { label: "Consumers", value: DEMO_STATS.activeConsumers.toLocaleString(), icon: <Users className="h-4 w-4 text-purple-500" /> },
          { label: "Rewards Issued", value: String(DEMO_STATS.rewardsIssued), icon: <Trophy className="h-4 w-4 text-amber-500" /> },
        ].map((item) => (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="rounded-xl bg-white border">
          <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
            ...
            <Link to="/admin/consumer-overview/campaigns" className="text-xs font-medium text-primary-600 hover:text-primary-700">View all</Link>
          </div>
