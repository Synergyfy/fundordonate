// =============================================================================
// UK Hub — Business Campaign List Page
// Shows only business-oriented campaigns for a specific High Street.
// =============================================================================
...
import {
  ...
  ChevronRight, Store, Briefcase,
} from "lucide-react";

const fmtCurrency = (v: number) =>
  new Intl.NumberFormat("en-GB", { style: "currency", currency: "GBP", maximumFractionDigits: 0 }).format(v);

export default function BusinessCampaignListPage() {
  ...
  const campaigns = useMemo(
    () => allCampaigns.filter(c => c.targetAudience === "business" || c.targetAudience === "both"),
    [allCampaigns],
  );
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
        ...
        <HubBreadcrumb
          items={[
            ...breadcrumbs,
            { label: "Business Campaigns", slug: "business", fullPath: `${citySlug}/${localAreaSlug}/${highStreetSlug}/business`, type: "HIGH_STREET" },
          ]}
        />
      </div>
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-8 sm:py-12 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-sm font-medium text-blue-300">For Business</span>
            </div>
            <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">
              Business Campaigns
            </h1>
            <p className="mt-3 text-lg text-gray-300 max-w-2xl">
              Campaigns and opportunities available to Business Owners on {streetName}, {areaName}.
            </p>
      ...
      <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-lg font-bold text-gray-900">
            {campaigns.length} Business {campaigns.length === 1 ? "Campaign" : "Campaigns"}
          </h2>
        ...
        {campaigns.length === 0 ? (
          <div className="rounded-xl bg-white border p-12 text-center">
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-2">No Business Campaigns Available</h3>
            <p className="text-sm text-gray-500 max-w-md mx-auto">
              No business campaigns are currently available for this High Street. Check back soon or explore consumer campaigns.
            </p>
            <Link
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {campaigns.map((campaign) => {
              ...
              const campaignLink = `/uk-hub-activation/${citySlug}/${localAreaSlug}/${highStreetSlug}/business/campaign/${campaign.slug}`;
